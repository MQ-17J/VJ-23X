...
; =================================================================================================================
; octonion multiplication AVX-512
; =================================================================================================================
; >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
;
; The math:
...
; C prototype:
;
; void octonion_div64_AVX512(octonion *o1, octonion *o1, octonion *result);
;
; -----------------------------------------------------------------------------------------------------------------
;
...
; C prototype:
;
; void octonion_norm64_AVX512(octonion *o, double *result);
;
; -----------------------------------------------------------------------------------------------------------------
;
