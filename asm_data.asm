...
; -----------------------------------------------------------------------------------------------------------------
;
; the temps data segment (read/write)
;
temps segment align(64)

temp_xmm6  real8 0.0, 0.0 ; these are needed for the Windows ABI, eliminates stack manipulation
temp_xmm7  real8 0.0, 0.0
temp_xmm8  real8 0.0, 0.0
temp_xmm9  real8 0.0, 0.0
temp_xmm10 real8 0.0, 0.0
